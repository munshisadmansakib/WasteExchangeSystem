...
if($_POST["newpass"]== $_POST["cpass"] && ($_POST["pass"])== $_SESSION['pass']){	
	 $updatedata = array(
		'name' => $_POST["name"],
		'email'=> $_POST["email"],
...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto w-100 justify-content-end">
	  <li class="nav-item">
        <a class="nav-link" href="adminhome.php"><b>Home</b></a>
      </li>
      <li class="nav-item">
...
<br><br><br> <h5>
Name: <span class="user"> <?= $_SESSION['name'] ?> </span> </br>
Email address: <span class="user"> <?= $_SESSION['email'] ?> </span> </br>
Contact No. : <span class="user"> <?= $_SESSION['contact'] ?> </span> </br> </h5>

<br><br><br>
<a class="btn btn-info btn-lg" href="adminhome.php" role="button">Back</a>
